...
Comment.create!([
  {body: "Oh my. This looks [like a hyperlink](http://example.com/some-url).", user_id: 2, commentable_id: 101, commentable_type: "SingleEvent"}
])

Authorization.create!([
  {provider: "github", uid: "1337", user_id: 1, token: nil, secret: nil, token_expires: nil, temp_token: nil},
])

EventCuration.create!([
  {user_id: 2, event_id: 3}
])

RegionOrganizer.create!([
  {region_id: 2, user_id: 2}
])

Tagging.create!([
  {tag_id: 1, taggable_id: 3, taggable_type: "Event", tagger_id: nil, tagger_type: nil, context: "tags"},
  {tag_id: 2, taggable_id: 3, taggable_type: "Event", tagger_id: nil, tagger_type: nil, context: "tags"},
