...
* If you need help setting this project up, check out the [README](README.md). If you run into problems setting up the project for development: Get in contact by [opening an issue](https://github.com/hacken-in/hacken-in/issues/new).
